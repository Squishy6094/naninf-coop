...
extern Vtx empty_dl_Plane_mesh_layer_5_vtx_cull[8];
extern Vtx empty_dl_Plane_mesh_layer_5_vtx_0[4];
extern Gfx empty_dl_Plane_mesh_layer_5_tri_0[];
extern Gfx mat_empty_dl_empty_mat[];
extern Gfx mat_revert_empty_dl_empty_mat[];
extern Gfx empty_dl_Plane_mesh_layer_5[];
